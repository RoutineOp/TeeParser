...
type
  DSInfoReq = (dsNumSources, dsDefSources, dsSource, dsFieldSource,
     dsFieldDefault, dsFieldDomainExpr, dsTblConstraint, dsNumTblConstraint);
...
procedure OsLdLoadBySymbName(DrvName:String; var Result:Pointer);
procedure OsLdUnloadObj(var Value:Pointer);
function OsLdStrnCmp(Locale:Pointer; S1, S2:PChar; Len:Integer):Integer;
function OsLdStrnCmpi(Locale:Pointer; S1, S2:PChar; Len:Integer):Integer;
function OsLdStrCmp(Locale:Pointer; S1, S2:PChar):Integer;
function OsLdStrCmpi(Locale:Pointer; S1, S2:PChar):Integer;

function DbiCfgPosition(P:Pointer; CfgPath:PChar):Integer;
function DbiCfgDropRecord(P:Pointer; CfgPath:PChar):Integer;

function DbiCfgSave(A,B:Pointer; C:Boolean):Integer;

function DbiCfgModifyRecord(A:Pointer; B:PChar; FieldCount:Integer;
        var FieldDescs:PFLDDesc; Buffer:Pointer):Integer;

function DbiGetLdNameFromDB(FHandle: HDBIDB; P:Pointer; LName:DBIName):Integer;

function DbiSchemaCacheFlush(FHandle:HDBIDB; TableName:PChar):Integer;
function DbiBeginConstraintLayer(P:Pointer; FHandle:HDBICUR; C:Pointer; I:Integer):Integer;
function DbiEndConstraintLayer(FHandle:HDBICUR):Integer;

const
  clSQLRESTRICT =0; // ?
  szMTXCONTEXTOBJ=''; // ?
  OPENMODEFLAG_DIRTYREAD=0; // ?
  OPENMODEFLAG_READCOMMITTED=0;
  OPENMODEFLAG_REPEATABLEREAD=0;
